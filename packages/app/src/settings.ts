...
interface SettingsFile {
  ...
  locale?: string;
  // Whether to fire a silent update check at startup. Default true.
  // The user can flip this from Preferences; the manual "Help → Check
  // for updates" item still works regardless.
